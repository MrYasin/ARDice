...
//        let cube = SCNBox(width: 0.6, height: 0.6, length: 0.6, chamferRadius: 0.01)
//        let sphere = SCNSphere(radius: 0.2)
//
//
//        let material = SCNMaterial()
//        material.diffuse.contents = UIImage(named: "art.scnassets/8k_saturn.jpg")
            ...
            if let hitResult = results.first{
                ...
                if let diceNode = diceScene.rootNode.childNode(withName: "Dice", recursively: true) {
                    ...
                    diceNode.position = SCNVector3(x: hitResult.worldTransform.columns.3.x,
                                                   // adding diceNode radius so dice will go flat on grid
